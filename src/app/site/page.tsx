  ...
  return (
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col ">
        ...
        <p className="text-center lg:mt-72">Run your agency, in one place</p>
      ...
      <section className="flex justify-center items-center flex-col gap-4  md:!mt-20 mt-[-20px] lg:!pt-64">
        <h1 className="text-4xl text-center "> Choose what fits you</h1>
        <p className="text-muted-foreground text-center ">
          Our Straightforward pricing plans are tailored to your needs. If{" "}
          {" you're"} ready to commit you can get started for free.
        </p>
